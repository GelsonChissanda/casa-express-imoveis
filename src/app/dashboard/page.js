        ...
        <div className="bg-linear-to-r from-blue-900 to-blue-700 pt-24 pb-12">
          <div className="max-w-6xl mx-auto px-4">
            <div className="flex justify-between items-center">
              ...
              <button onClick={() => logout().then(() => router.push("/"))} className="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">Sair</button>
            </div>
          </div>
        </div>
  ...
  />
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex gap-2">
                          <button onClick={() => router.push(`/casas/${casa.id}`)} className="flex-1 px-3 py-2 bg-blue-100 text-blue-600 rounded hover:bg-blue-200 text-sm">Ver</button>
