        ...
        <div className="flex items-center justify-center min-h-[80vh] px-4">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center max-w-md w-full">
            ...
            <p className="text-gray-500 text-sm mb-7">
              O teu anúncio &quot;<strong>{form.titulo}</strong>&quot; foi publicado com sucesso.
            </p>
            <div className="flex flex-col gap-3">
              ...
              <button
                onClick={() => {
                  setSubmetido(false);
                  setForm({ titulo: "", descricao: "", preco: "", bairro: "", quartos: "", casasDeBanho: "", tipo: "", whatsapp: "" });
                  setFotos([]);
                }}
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <h2 className="font-bold text-gray-800 mb-4 flex items-center gap-2">
              ...
              Fotos da casa <span className="text-gray-400 text-xs font-normal ml-1">({fotos.length}/4)</span>
            </h2>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                {fotos.map((foto, i) => (
                  <div key={i} className="relative rounded-xl overflow-hidden aspect-square">
                    <Image src={foto.preview} alt={`Foto ${i + 1}`} className="w-full h-full object-cover" width={200} height={200} />
                    {i === 0 && (
                      <span className="absolute top-1 left-1 bg-blue-600 text-white text-xs px-2 py-0.5 rounded-full font-semibold">Principal</span>
                    )}
                    <button
            ...
            {fotos.length < 4 && (
              ...
              >
                ...
                <p className="text-gray-400 text-xs">
                  Até {4 - fotos.length} foto{4 - fotos.length !== 1 ? "s" : ""} • JPG, PNG ou WEBP
                </p>
              </div>
            )}
 
            <input id="upload-fotos" type="file" accept="image/*" multiple className="hidden" onChange={adicionarFotos} />
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2">
                <label className="block text-xs font-semibold text-gray-600 mb-1.5">WhatsApp do proprietário <span className="text-red-500">*</span></label>
                <div className="relative">
