        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-3">
            <div className="flex-1 relative">
              ...
              <input type="text" placeholder="Pesquisar por bairro..." value={pesquisa}
      ...
      <section id="como-funciona" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mt-2">Como funciona</h2>
            <p className="text-gray-500 mt-3 max-w-lg mx-auto">Em 3 passos simples encontras e arrendas a tua casa ideal em Luanda</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { step: "01", titulo: "Procura", desc: "Pesquisa por bairro, preço ou tipologia. Filtra até encontrares a casa ideal.", icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" },
              { step: "02", titulo: "Visita", desc: "Marca uma visita directamente pela plataforma. O intermediário confirma.", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
              { step: "03", titulo: "Arrenda", desc: "Gosta da casa? Assina o contrato e muda-te para o teu novo lar.", icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" },
            ].map((item) => (
              <div key={item.step} className="text-center p-8 rounded-2xl bg-[#F7F8FC] hover:bg-blue-50 transition-colors group">
                <div className="relative inline-flex mb-6">
                  ...
                  <span className="absolute -top-2 -right-2 w-7 h-7 bg-blue-100 text-blue-800 text-xs font-black rounded-full flex items-center justify-center border-2 border-white">{item.step}</span>
                </div>
      ...
      <section className="py-20 bg-[#F7F8FC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-10">
            <div>
              <span className="text-blue-600 font-semibold text-sm uppercase tracking-wider">Selecção do editor</span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mt-2">Casas em Destaque</h2>
            </div>
      ...
      <section id="bairros" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="text-blue-600 font-semibold text-sm uppercase tracking-wider">Explorar por zona</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mt-2">Bairros em Destaque</h2>
            <p className="text-gray-500 mt-3">Descobre casas nos melhores bairros de Luanda</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-blue-900 to-blue-700 rounded-3xl p-10 sm:p-14 text-center relative overflow-hidden">
            ...
            <div className="relative">
              <span className="inline-block bg-white/20 text-white text-xs font-bold px-4 py-1.5 rounded-full mb-5 border border-white/30">Para Intermediários</span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">Publica as tuas casas<br />e alcança mais clientes</h2>
              <p className="text-blue-100 text-lg max-w-xl mx-auto mb-8">Junta-te a mais de 45 intermediários que já usam a CasaExpress para arrendar as suas casas mais rápido.</p>
